...
log <-  (read_tsv("/Volumes/MAPS1/Participant Recordings/MAPS-007/raw/MAPS-007_log.tsv"))
...
```{r export_csv}
write.csv(log_sync, file = "/Volumes/MAPS1/Participant Recordings/MAPS-007/synced/MAPS-007_log_webcam_sync.csv")
```
