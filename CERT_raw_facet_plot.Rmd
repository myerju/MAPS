...
=======
### todo: Julianne 
### fix capitalization in replace all
```{r import_data}
#On Box for Julianne - change name to match csv
##CSV FILE
#JMM_yawn1 <- read_csv("/Users/myerju/Box Sync/MAPS/Data/JMM_yawn1.csv", skip=2, col_names= FALSE, na = "NaN")

#EXCEL FILE
#JMM_yawn1 <- read_excel("/Users/myerju/Box Sync/MAPS/Data/JMM_yawn1.xlsx", skip=2, col_names= FALSE, na = "NaN")

#TEXT FILE
#JMM_yawn1 <- read.table("/Users/myerju/Box Sync/MAPS/Data/JMM_yawn1.txt", sep="\t", skip = 2, header = FALSE, na.strings = "NaN")

#On Laptop for Julianne - change name to match csv

##CSV FILE
#JMM_yawn1 <- read_csv("/Users/julianne/Box Sync/MAPS/Data/JMM_yawn1.csv", skip=2, col_names= FALSE, na = "NaN")

#EXCEL FILE
#JMM_yawn1 <- read_excel("/Users/julianne/Box Sync/MAPS/Data/JMM_yawn1.xlsx", skip=2, col_names= FALSE, na = "NaN")

#TEXT FILE
#JMM_yawn1 <- read.table("/Users/julianne/Box Sync/MAPS/Data/JMM_yawn1.txt", sep="\t", skip = 2, header = FALSE, na.strings = "NaN")

#On Laptop for Marissa - change name to match csv

##CSV FILE
#JMM_yawn1 <- read_csv("/Users/Marissa Renda/Documents/Senior Fall 2016/PSY499 - Senior Thesis/CERT/cert_stim/cert_stim_1.1_data.csv", skip=2, col_names= FALSE, na = "NaN")

#EXCEL FILE
#JMM_yawn1 <- read_excel("/Users/Marissa Renda/Documents/Senior Fall 2016/PSY499 - Senior Thesis/CERT/cert_stim/cert_stim_1.1_data.csv", skip=2, col_names= FALSE, na = "NaN")

#TEXT FILE
#JMM_yawn1 <- read.table("/Users/Marissa Renda/Documents/Senior Fall 2016/PSY499 - Senior Thesis/CERT/cert_stim/cert_stim_1.1_data.txt", sep="\t", skip = 2, header = FALSE, na.strings = "NaN")
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
...
=======
duplicates <- duplicated(JMM_yawn1[,1]) 
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
...
=======
   JMM_yawn1 <- JMM_yawn1[-(1), -(1:25)]
} else {
   JMM_yawn1 <- JMM_yawn1[-(1:restart_row), -(1:25)]
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
}
```
...
=======
colnames(JMM_yawn1) <- names

#make all column names lowercase
names(JMM_yawn1) <- names(JMM_yawn1) %>%
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
  tolower() 
```
...
str(cert_stim_4)
=======
JMM_yawn1[,c(1:42)] <- as.numeric(as.character(unlist(JMM_yawn1[,c(1:42)])))
...
<<<<<<< HEAD
=======
*Note:* PROBLEM TO SOLVE - cert_stim_1.1_data.csv has an odd graph format - let's start to problem solve different types of data
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
...
=======
au<- ggplot(JMM_yawn1, aes(x=frame, y=au_26_jaw_drop))
au<- au+ geom_line()
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
...
=======
JMM_yawn1_long <- gather(JMM_yawn1_new, au, intensity, au_1_inner_brow_raise:neutral_v3)
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
```
...
=======
au_total<- ggplot(JMM_yawn1_long, aes(x=frame, y=intensity))
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
...
=======
#ggsave(au_total, file = "/Users/myerju/Box Sync/MAPS/figs/JMM_yawn1.pdf", height=9, width=12) 

#On Laptop for Julianne - change name to match csv
#ggsave(au_total, file = "/Users/myersju/Desktop/Box Sync/MAPS/Figs/JMM_yawn1.pdf", height=9, width=12)

#On Laptop for Marissa - change name to match csv
#ggsave(au_total, file = "/Users/Marissa Renda/Documents/Other Work/JMM_yawn1.pdf", height=9, width=12)
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
...
=======
JMM_yawn1_color <- JMM_yawn1_long %>%
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
...
=======
au_color<- ggplot(JMM_yawn1_color, aes(x=frame, y=intensity))
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
...
=======
#ggsave(au_color, file = "/Users/myerju/Box Sync/MAPS/figs/JMM_yawn1_color.pdf", height=9, width=12) 

#On Laptop for Julianne - change name to match csv
#ggsave(au_color, file = "/Users/myersju/Desktop/Box Sync/MAPS/Figs/JMM_yawn1_color.pdf", height=9, width=12)

#On Laptop for Marissa - change name to match csv
#ggsave(au_color, file = "/Users/Marissa Renda/Documents/Other Work/JMM_yawn1_color.pdf", height=9, width=12)
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
...
coef(lm(pitch ~ yaw, data = JMM_yawn1))
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
...
=======
au_placement <- ggplot(JMM_yawn1, aes(x=pitch, y=yaw))
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
...
=======
au_placement <- ggplot(JMM_yawn1, aes(x=pitch, y=roll))
>>>>>>> 3f197247988379f6c469ae5a50463576f8b064c8
au_placement <- au_placement+ geom_point()
au_placement <- au_placement+ geom_smooth(method = "lm")
