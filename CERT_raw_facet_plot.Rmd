...
#MARISSA'S LAPTOP
#setwd("/Users/Marissa Renda/Documents/Senior Fall 2016/PSY 499 - Senior Thesis/CERT/cert_stim")
...
au_total<- au_total+ ggtitle("cert_stim_4")  #Make sure to change this with the expression you're analyzing.
au_total
...
#ggsave(au_total, file = "/Users/Marissa Renda/Documents/Senior Fall 2016/PSY 499 - Senior Thesis/CERT/cert_stim/cert_stim_4.pdf", height=9, width=12)
...
au_color<- au_color+ ggtitle("cert_stim_4")  #Make sure to change this with the expression you're analyzing.
au_color
...
au_placement <- au_placement+ ggtitle("cert_stim_4 - Head Placement (Pitch and Yaw)")
au_placement
```
...
au_placement <- au_placement+ geom_point()
au_placement <- au_placement+ geom_smooth(method = "lm")
au_placement <- au_placement+ ggtitle("cert_stim_4 - Head Placement (Pitch and Roll)")
au_placement
```
